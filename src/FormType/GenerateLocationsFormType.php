...
/**
 * @extends AbstractType<GenerateLocationsFormData>
 */
final class GenerateLocationsFormType extends AbstractType
{
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => GenerateLocationsFormData::class,
        ]);
    }
}
